            ...
            <Modal show={showModal} onHide={handleModalClose} centered>
                ...
                <Modal.Body className='p-0'>
                    <div className='modal-wrapper'>
                        ...
                        <p className='privacy-policy'>By continuing you agree to our <a href="#">Terms of Service and Privacy Policy.</a></p>
                        <input type="email" placeholder='Email' className='input-field'></input>
                        <a href="#" className='social-links'>Or connect with social media</a>

                        <div className='continue-with-links'>
                            <a href="#"> <img src={google}/>  Continue with Google</a>
