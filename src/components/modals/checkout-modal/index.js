        ...
        <Modal.Body className="p-0">
          <div className="Checkout-modal-wrapper">
            ...
            <div className="mb-0 ms-0 me-0" style={{marginTop:'11px'}}>
              ...
              <h3 className="suggestion-line">Add these top picks to your order</h3>
          <div className="card-container">
            ...
            {/* table start*/}
            <div className="biling-detail position-relative" style={{marginTop:'25px'}}>
              <table style={{width:'100%'}}>
                ...
                <tr className="no-border">
                  ...
                  <td><span className="EstimateCost">Estimated Cost </span> $ 2.0</td>
                </tr>
                <tr className="no-border">
                  <td>Total Cost</td>
