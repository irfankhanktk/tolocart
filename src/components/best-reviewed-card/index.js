        ...
        <div className='col-md-12 position-relative'>
            <div className='csm-product-card '>
                ...
                <div className='text-center'>
                    <img className='img-fluid mx-auto' src={review_img} alt='image here' />
                </div>
                <p className='font-size-normal product-title'>{title}</p>
                <p className='font-size-small color-white-50 product-weight'>{3.5} oz</p>
                <p className='font-size-small stock-product' style={{ color: '#1F9F0C' }}>In stock</p>
